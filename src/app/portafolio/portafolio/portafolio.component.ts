...
export class PortafolioComponent implements OnInit {
  ...
  portafolio = [
    ...
    },
    {
      titulo: 'Tecactiva',
      subtitulo: 'HTML, CSS, TS, ANGULAR',
      img: 'assets/img/TECACTIVA.PNG',
      descripcion: 'Landing page con registro, login, cambio de clave, tabla de datos y dashboard simulado.',
      enlace: 'https://ohincapie.github.io/PruebaTecactiva/',
      github: 'https://github.com/OHincapie/PruebaTecactiva'
    },
    {
      titulo: 'App salon',
